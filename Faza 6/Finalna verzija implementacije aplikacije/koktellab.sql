CREATE DATABASE  IF NOT EXISTS `koktellab` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `koktellab`;
-- MySQL dump 10.13  Distrib 8.0.19, for Win64 (x86_64)
--
-- Host: localhost    Database: koktellab
-- ------------------------------------------------------
...
INSERT INTO `koktel` VALUES (1,1,'Martini','Pomešajte vermut i džin sa kockicama leda i promućkajte. Sipajte u čašu i dodajte 2-3 masline.','vodka-martini-recipe.jpg',NULL,0,'2020-05-09 22:00:00'),(2,2,'Margarita','Ako koristite so, onda je sipajte u plitku posudu. Obod čaše natapkajte natopljenom maramicom, a potom ubacite u so. Napunite čašu ledom, dodajte tekilu, sok od limete i na kraju liker od pomorandže. Promešajte i poslužite odmah!','Mock-Margaritas-1.jpg',NULL,0,'2020-05-09 22:00:00'),(3,2,'Pina Colada','Napunite šejker ledom i dodajte sve sastojke. Izmućkajte i prespite u duboku čašu sa niskom stopom. Ovo piće zahteva i adekvatnu dekoraciju u vidu trougla ananasa i kišobrančića zabodenog u njega.','frozen-pina-colada-recipe-.jpg',NULL,0,'2020-05-09 22:00:00'),(4,2,'Cuba Libre','Napunite čašu kockicama leda, prelijte ga rumom, potom sokom od limete i na kraju coca-colom. Vaš koktel je spreman za serviranje!','cocktail-cuba-libre-vicky-wasik-1500x1125.jpg',NULL,0,'2020-05-09 22:00:00'),(5,2,'White Russian','Pomešajte čašicu votke, dve kašike likera od kafe i kašiku mleka (može i slatka pavlaka). Rezultat je ukusan i kremast koktel, uz koji ćete sigurno lepo provesti praznično veče.','Keto-White-Russian-1.jpg',NULL,0,'2020-05-09 22:00:00'),(6,2,'Mojito','Na dno čaše stavite kašiku smeđeg šećera, potom stavite mrvljeni led i  listove nane, a onda pospite rumom, sokom od limete i na kraju mineralnom vodom. Ukrasite čašu kolutovima limete.','90739-5197-mx.jpg',NULL,0,'2020-05-09 22:00:00'),(19,3,'Owlbear','Drink',NULL,NULL,0,'2020-06-04 22:00:00'),(20,3,'Goblin','Goblin is very small',NULL,NULL,0,'2020-06-05 10:18:35');
...
INSERT INTO `korisnik` VALUES (1,'admin','Admin123','admin@gmail.com'),(2,'PetarPet','peraABCD','petar@gmail.com'),(3,'AcaA','acaaca','aca@gmail.com'),(4,'MajaMaj','majaMaj','maja@gmail.com'),(7,'marko','marko','marko@gmail.com'),(8,'milica','milica','milica@gmail.com');
...
INSERT INTO `razlog` VALUES (1,'Recept nije tačan.'),(2,'Postoji sadržaj recepta koji nije vezan sa koktelom.'),(3,'Recept je duplikat drugog recepta.');
...
INSERT INTO `registrovani` VALUES (2,0),(3,0),(4,0),(7,0),(8,0);
...
INSERT INTO `sadrzineobavezno` VALUES ('2-3 komada',1,3),('malo',2,7),('15 ml',5,14);
...
INSERT INTO `sadrziobavezno` VALUES (1,1,'60ml'),(1,2,'15 ml'),(2,4,'60 ml'),(2,5,'15 ml'),(2,6,'30 ml'),(3,8,'60 ml'),(3,9,'60 ml'),(3,10,'120 ml'),(4,6,'isceđeno pola voćke'),(4,8,'50 ml'),(4,11,'100 ml'),(5,12,'2 kašike'),(5,13,'pola šolje'),(5,18,'60 ml'),(6,8,'60 ml'),(6,15,'3 komada'),(6,16,'2 kašike'),(6,17,'100 ml'),(19,1,'0.1l'),(19,11,'0.1l'),(20,1,'0.1l'),(20,11,'0.2l');
...
INSERT INTO `sastojak` VALUES (11,'coca-cola'),(1,'džin'),(9,'kokosovo mleko'),(12,'liker od kafe'),(5,'liker od pomorandže'),(15,'listovi sveže nane'),(3,'masline'),(17,'mineralna voda'),(13,'mleko'),(8,'rum'),(14,'slatka pavlaka'),(7,'so'),(10,'sok od ananasa'),(6,'sok od limete'),(4,'tekila'),(2,'vermut'),(18,'votka'),(16,'žuti šećer');
...
-- Dump completed on 2020-06-05 12:19:23
