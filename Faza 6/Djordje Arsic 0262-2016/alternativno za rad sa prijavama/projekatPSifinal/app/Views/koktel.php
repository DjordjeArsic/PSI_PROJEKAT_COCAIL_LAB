<?php 
    ...
    echo "<br/>Datum obljavljivanja: ".$koktelInfo->koktel->datum;
    echo '</p>';
    ...
    if ($korisnik->isAdmin) {       
        ...
        if ($korisnik->idKorisnika==$koktelInfo->koktel->idKorisnika) {
            ...
            echo '<br/><input type="button" onclick="prikaziFormuZaPrijavu()" class="btn btn-primary" style="margin-bottom: 10px;" value="Prijavite recept"><br/>';
