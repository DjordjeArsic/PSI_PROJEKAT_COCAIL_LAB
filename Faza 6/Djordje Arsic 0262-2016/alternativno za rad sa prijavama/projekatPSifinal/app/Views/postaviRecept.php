...
<div class="container">
        ...
        <div class="col-xs-10 col-md-7">
            <?php
                foreach($sastojci as $value) {  
                    echo "<span class='ml-3'><label><input type='checkbox' value='$value' onclick='toggleVis(this)'>";
    ...
    <?php
        foreach($sastojci as $value) {
            ...
            echo "<div class='col-xs-12 col-md-3'><input type='checkbox' name='neobavezni[]' value='$value'> Neobavezan sastojak</div>";
            echo "</div>";
        }
    ?>
