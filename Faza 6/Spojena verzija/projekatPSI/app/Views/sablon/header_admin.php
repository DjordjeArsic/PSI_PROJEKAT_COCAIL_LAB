    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary border-bottom pt-3 pb-3">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <?php echo "<a class='nav-link' href='".site_url("Admin/index")."' id='pretraga'>Početna</a>";?>
          </li>
          <li class="nav-item">
            <?php echo "<a class='nav-link' href='".site_url("Admin/reportovaniRecepti")."' id='reportovaniRecepti'>Prijavljeni recepti</a>";?>            
          </li>
          <li class="nav-item">
            <?php echo "<a class='nav-link' href='".site_url("Korisnik/postaviRecept")."' id='postaviRecept'>Objavite recept</a>";?>            
          </li>
          <li>
            <?php echo "<a class='nav-link' href='".site_url("Admin/mojiKokteli")."' id='mojiRecepti'>Moji recepti</a>";?>
          </li>
          <li>
