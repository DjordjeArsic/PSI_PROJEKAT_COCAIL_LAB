...
(1, 1, 'Martini', 'Pomešajte vermut i džin sa kockicama leda i promućkajte. Sipajte u čašu i dodajte 2-3 masline.', 'vodka-martini-recipe.jpg', NULL, 0, '2020-05-10 05:54:43'),
(2, 2, 'Margarita', 'Ako koristite so, onda je sipajte u plitku posudu. Obod čaše natapkajte natopljenom maramicom, a potom ubacite u so. Napunite čašu ledom, dodajte tekilu, sok od limete i na kraju liker od pomorandže. Promešajte i poslužite odmah!', 'Mock-Margaritas-1.jpg', NULL, 0, '2020-05-10 10:08:12'),
(3, 2, 'Pina Colada', 'Napunite šejker ledom i dodajte sve sastojke. Izmućkajte i prespite u duboku čašu sa niskom stopom. Ovo piće zahteva i adekvatnu dekoraciju u vidu trougla ananasa i kišobrančića zabodenog u njega.', 'frozen-pina-colada-recipe-.jpg', NULL, 0, '2020-05-10 18:03:32'),
(4, 2, 'Cuba Libre', 'Napunite čašu kockicama leda, prelijte ga rumom, potom sokom od limete i na kraju coca-colom. Vaš koktel je spreman za serviranje!', 'cocktail-cuba-libre-vicky-wasik-1500x1125.jpg', NULL, 0, '2020-05-10 08:12:55'),
(5, 2, 'White Russian', 'Pomešajte čašicu votke, dve kašike likera od kafe i kašiku mleka (može i slatka pavlaka). Rezultat je ukusan i kremast koktel, uz koji ćete sigurno lepo provesti praznično veče.', 'Keto-White-Russian-1.jpg', NULL, 0, '2020-05-10 01:22:22'),
(6, 2, 'Mojito', 'Na dno čaše stavite kašiku smeđeg šećera, potom stavite mrvljeni led i  listove nane, a onda pospite rumom, sokom od limete i na kraju mineralnom vodom. Ukrasite čašu kolutovima limete.', '90739-5197-mx.jpg', NULL, 0, '2020-05-10 09:11:55');
